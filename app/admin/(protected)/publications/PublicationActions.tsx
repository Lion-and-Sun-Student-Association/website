...
/** Role- and status-aware review controls for a publication. */
  ...
  return (
    <div className="flex items-center gap-2">
      {submittable && !canReview && (
        <button
          disabled={pending}
          onClick={() => start(() => submitPublication(id))}
      ...
      {canReview && submittable && (
        <button
          disabled={pending}
          onClick={() => start(() => publishPublication(id))}
        ...
        <>
          ...
          <button
            ...
            onClick={() => {
              ...
              if (note) start(() => requestPublicationChanges(id, note));
            }}
